...
bounce rate, and aggregate differences ONLY for users who landed on the viagogo homepage from an email link.
"""
...
def main(args):
    ...
    primary_results.to_csv('secondary_results_land_email_only.csv')
    ...
    results.to_csv('secondary_summary_results_land_email_only.csv')
